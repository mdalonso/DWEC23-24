...
export const addCliente=async(req, res)=>{
    try {
        ...
        const {nameCliente, emailCliente, tlfnoCliente, empresaCliente}=req.body;
         ...
         const [result]=await conexion.query("INSERT INTO clientes (nombreCliente, emailCliente, tlfnoCliente, empresaCliente) VALUES (?,?,?,?)", [nameCliente, emailCliente, tlfnoCliente, empresaCliente]);
         console.log(result);
